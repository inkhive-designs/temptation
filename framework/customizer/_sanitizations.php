...
function temptation_sanitize_checkbox( $input ) {
    if ( $input == 1 ) {
        return 1;
    } else {
        return '';
...
function temptation_sanitize_positive_number( $input ) {
...
function temptation_sanitize_category( $input ) {
...
function temptation_sanitize_product_category( $input ) {
